...
const page = () => {
  ...
  const text1 =
    "Advancing Business Potential through Cutting-Edge Technology Solutions.";
      ...
      items: [
        {
          ...
          description:
            "A suite driven by data and powered by automation, designed to reimagine customer engagements across critical service landscapes.",
          link: "/contact-us",
        },
      ],
    },
      ...
      items: [
        {
          ...
          description:
            "Empowering intelligent interventions through cognitive technologies in risk data and control assurance.",
          link: "/contact-us",
        },
        {
          title: "Risk Radar: An Early Alert System",
          description:
            "Utilizing machine learning, this system monitors, evaluates, and addresses counterparty risks in real-time.",
          link: "/contact-us",
        },
      ],
    },
      ...
      items: [
        {
          ...
          description:
            "Comprehensive offerings and services to fortify defenses against fraudulent activities.",
          link: "/contact-us",
        },
        {
          title: "Sentinel Cybersecurity Platform",
          description:
            "Leveraging advanced analytics, VSC provides managed detection and response services to proactively combat cyber threats.",
          link: "/contact-us",
        },
      ],
    },
  ...
  return (
    <div>
      ...
      <Screen3
        content={content}
        sections={sections}
        mainp="Let's transform your bank together with next-gen AI solutions."
      />
      <Services />
      <Technologies />
    </div>
