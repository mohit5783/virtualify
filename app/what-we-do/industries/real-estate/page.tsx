...
const realEstatePage = () => {
  ...
  const text1 = "Transforming property management and real estate experiences through innovation.";
      ...
      items: [
        {
          ...
          description: "A state-of-the-art platform designed to streamline property management operations and enhance efficiency.",
      ...
      items: [
        {
          ...
          description: "Leveraging data and AI to deliver personalized living experiences, boosting customer satisfaction and loyalty.",
      ...
      items: [
        {
          ...
          description: "A comprehensive system for managing real estate assets efficiently, ensuring optimal performance and maintenance.",
  ...
  return (
    <div>
      ...
      <ScreenText
        ...
        image1={rs}
      />
      <Screen3 content={content} sections={sections} mainp="Partner with us to innovate the real estate industry with cutting-edge solutions." />
      <Services />
      <Technologies />
    </div>
  );
